@echo off
echo ========================================
echo   Demarrage final eConsulat avec
echo   correction automatique de la base
echo ========================================
echo.
...
REM Corriger la base de données avec le script simplifié
echo ========================================
echo   Etape 1: Correction de la base de donnees
echo ========================================
echo.

call fix_demandes_simple.bat
