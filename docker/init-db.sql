-- Initialisation de la base eConsulat pour Docker
...
-- 10. Types de documents initiaux (tous les types courants pour les demandes)
...
-- 11. Utilisateurs par défaut (BCrypt : admin123 / user123, cf. PasswordTest.java)
