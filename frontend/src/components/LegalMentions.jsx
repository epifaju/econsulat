  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-gray-900">{t("legal.mentions.title")}</h1>
        <div className="mt-8 space-y-4 text-gray-600">
          <p>{t("legal.mentions.p1")}</p>
          <p>{t("legal.mentions.p2")}</p>
          <p>{t("legal.mentions.p3")}</p>
          <p>{t("legal.mentions.p4")}</p>
        </div>
      </main>
    </div>
  );
